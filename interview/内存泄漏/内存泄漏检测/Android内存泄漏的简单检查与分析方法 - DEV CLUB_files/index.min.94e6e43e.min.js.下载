...
$(document).ready(function(){var e=$("#responsive-sidebar-trigger"),t=$("#sidebar-mask"),n=$("#sidebar"),o=$("#main"),a=$(window).width(),c=0,i=0,d={x:0,y:0},h=a/3,r=function(){var a=e.data("is-show"),c=o.height(),i=n.outerHeight();n.css({right:a?-300:0}),e.data("is-show",!a),!a&&c<i&&o.height(i),t[a?"fadeOut":"fadeIn"]().height($("body").height())},s=function(e){var t=e.targetTouches;c=+t[0].pageX,i=+t[0].pageY,d.x=d.y=0,document.body.addEventListener("touchmove",u,!1),document.body.addEventListener("touchend",g,!1)},u=function(e){var t=e.changedTouches;d.x=+t[0].pageX-c,d.y=+t[0].pageY-i,Math.abs(d.x)>Math.abs(d.y)&&e.preventDefault()},g=function(t){var n=t.changedTouches,o=e.data("is-show");d.x=+n[0].pageX-c,!o&&c>3*a/4&&Math.abs(d.x)>h&&e.trigger("click"),o&&c<1*a/4&&Math.abs(d.x)>h&&e.trigger("click"),c=i=0,d.x=d.y=0,document.body.removeEventListener("touchmove",u,!1),document.body.removeEventListener("touchend",g,!1)};("ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch)&&document.body.addEventListener("touchstart",s),e.on("click",r),t.on("click",function(){e.trigger("click")})});
!function(e){function t(n){if(r[n])return r[n].exports;var a=r[n]={exports:{},id:n,loaded:!1};return e[n].call(a.exports,a,a.exports,t),a.loaded=!0,a.exports}var n=window.webpackJsonp;window.webpackJsonp=function(p,l){for(var o,c,i=0,s=[];i<p.length;i++)c=p[i],a[c]&&s.push.apply(s,a[c]),a[c]=0;for(o in l)e[o]=l[o];for(n&&n(p,l);s.length;)s.shift().call(null,t);if(l[0])return r[0]=0,t(0)};var r={},a={1:0};t.e=function(e,n){if(0===a[e])return n.call(null,t);if(void 0!==a[e])a[e].push(n);else{a[e]=[n];var r=document.getElementsByTagName("head")[0],p=document.createElement("script");p.type="text/javascript",p.charset="utf-8",p.async=!0,p.src=t.p+""+e+".javascripts/"+({0:"live"}[e]||e)+".js",r.appendChild(p)}},t.m=e,t.c=r,t.p="/public/"}([]);
